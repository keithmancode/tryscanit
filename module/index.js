 ...
 */
export function configure(licenseKey, { engineLocation = "/", highQualityBlurryRecognition = false, 
/**
 * @hidden
 */
loadTextRecognition = false, preloadBlurryRecognition = true, preloadEngine = true, } = {}) {
