 ...
 */
export declare function configure(licenseKey: string, { engineLocation, highQualityBlurryRecognition, 
/**
 * @hidden
 */
loadTextRecognition, preloadBlurryRecognition, preloadEngine, }?: {
