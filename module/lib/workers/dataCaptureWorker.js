...
export function dataCapture() {
    ...
    function loadLibrary(deviceId, libraryLocation, locationPath, preload, newDelayedRegistration, newHighEndBlurryRecognition, textRecognition, newLicenseKey, deviceModelName) {
        ...
        const { jsURI, wasmURI } = getLibraryLocationURIs(libraryLocation, textRecognition);
        preloading = preload;
        ...
        function verifyResponseData(responseData) {
            ...
            if (typeof crypto?.subtle?.digest === "function") {
                crypto.subtle
                    ...
                    const expectedHashString = textRecognition ? "%SDC_OCR_WASM_HASH%" : "af589054f25bfd099045069f48e42986dabd545d2207d5046fea447d49bfd11a";
                    // istanbul ignore if
