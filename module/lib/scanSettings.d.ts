...
export declare class ScanSettings {
     ...
     * @hidden
     */
    recognitionMode, enabledSymbologies, codeDuplicateFilter, maxNumberOfCodesPerFrame, searchArea, gpuAcceleration, blurryRecognition, codeDirectionHint, deviceName, }?: {
        /**
         * @hidden
         */
