...
function dataCapture() {
  ...
  function loadLibrary(deviceId, libraryLocation, locationPath, preload, newDelayedRegistration, newHighEndBlurryRecognition, textRecognition, newLicenseKey, deviceModelName) {
    ...
    const _getLibraryLocationUR = getLibraryLocationURIs(libraryLocation, textRecognition),
    ...
    Module = {
      ...
      instantiateWasm: function instantiateWasm(importObject, successCallback) {
        ...
        if (wasmJSVersion !== "5.8.0") {
          console.error("The Scandit Data Capture library JS file found at ".concat(jsURI, " seems invalid: ") + "expected version doesn't match (received: ".concat(wasmJSVersion, ", expected: ", "5.8.0", "). ") + "Please ensure the correct Scandit Data Capture file (with correct version) is retrieved.");
        }

        if (typeof self.WebAssembly.instantiateStreaming === "function") {
          instantiateWebAssemblyStreaming(importObject, wasmURI, textRecognition, successCallback);
        } else {
          instantiateWebAssembly(importObject, wasmURI, textRecognition, successCallback);
        }
  ...
  function getLibraryLocationURIs(libraryLocation, textRecognition) {
    let cdnURI = false;

    if (/^https?:\/\/([^\/.]*\.)*cdn.jsdelivr.net\//.test(libraryLocation)) {
      libraryLocation = "https://cdn.jsdelivr.net/npm/scandit-sdk@5.8.0/build/";
      cdnURI = true;
    } else if (/^https?:\/\/([^\/.]*\.)*unpkg.com\//.test(libraryLocation)) {
      libraryLocation = "https://unpkg.com/scandit-sdk@5.8.0/build/";
      cdnURI = true;
    }

    if (cdnURI) {
      return {
        jsURI: "".concat(libraryLocation, "scandit-engine-sdk").concat(textRecognition ? "-ocr" : "", ".min.js"),
        wasmURI: "".concat(libraryLocation, "scandit-engine-sdk").concat(textRecognition ? "-ocr" : "", ".wasm")
      };
    }

    return {
      jsURI: "".concat(libraryLocation, "scandit-engine-sdk").concat(textRecognition ? "-ocr" : "", ".min.js?v=5.8.0"),
      wasmURI: "".concat(libraryLocation, "scandit-engine-sdk").concat(textRecognition ? "-ocr" : "", ".wasm?v=5.8.0")
    };
  }
  ...
  function verifiedWasmFetch(wasmURI, textRecognition, awaitFullResponse) {
    function verifyResponseData(responseData) {
      ...
      if (typeof ((_crypto = crypto) === null || _crypto === void 0 ? void 0 : (_crypto$subtle = _crypto.subtle) === null || _crypto$subtle === void 0 ? void 0 : _crypto$subtle.digest) === "function") {
        crypto.subtle.digest("SHA-256", responseData).then(function (hash) {
          ...
          const expectedHashString = textRecognition ? "%SDC_OCR_WASM_HASH%" : "af589054f25bfd099045069f48e42986dabd545d2207d5046fea447d49bfd11a"; // istanbul ignore if

          if (hashString !== expectedHashString) {
            console.error("The Scandit Data Capture library WASM file found at ".concat(wasmURI, " seems invalid: ") + "expected file hash doesn't match (received: ".concat(hashString, ", ") + "expected: ".concat(expectedHashString, "). ") + "Please ensure the correct Scandit Data Capture file (with correct version) is retrieved.");
          }
        }).catch(
        /* istanbul ignore next */
        function () {// Ignored
  ...
  function instantiateWebAssembly(importObject, wasmURI, textRecognition, successCallback) {
    verifiedWasmFetch(wasmURI, textRecognition, true).then(function (response) {
  ...
  function instantiateWebAssemblyStreaming(importObject, wasmURI, textRecognition, successCallback) {
    verifiedWasmFetch(wasmURI, textRecognition, false).then(function (response) {
  ...
  _createClass(ScanSettings, [{
    ...
    value: function setRecognitionMode(recognitionMode) {
      ...
      if (recognitionMode.includes("text") && !textRecognition) {
        console.warn("The library has not been configured to load text recognition (ScanditSDK.configure() - loadTextRecognition option): ScanSettings' recognition mode for text will be ignored");
      }
    ...
    var _ref2 = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee(resolve, reject) {
      ...
      return regenerator.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              console.log("Scandit Web SDK version: 5.8.0");
...
export { Barcode, BarcodePicker, BrowserCompatibility, BrowserHelper, Camera, CameraAccess, CameraSettings, CustomError, ImageSettings, Parser, ScanResult, ScanSettings, Scanner, SingleImageModeSettings, SymbologySettings, TextRecognitionSettings, UAParser, blurryRecognitionPreloader, configure, configurePhase, configurePromise, dataCapture, dataCaptureLoader, dataCaptureWorkerBlob, deviceId, highEndBlurryRecognition, resetConfigure, scanditDataCaptureLocation, textRecognition, userLicenseKey };
