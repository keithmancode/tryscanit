...
function configure(licenseKey, _a) {
    var _this = this;
    var _b = _a === void 0 ? {} : _a, _c = _b.engineLocation, engineLocation = _c === void 0 ? "/" : _c, _d = _b.highQualityBlurryRecognition, highQualityBlurryRecognition = _d === void 0 ? false : _d, 
    /**
     * @hidden
     */
    _e = _b.loadTextRecognition, 
    /**
     * @hidden
     */
    loadTextRecognition = _e === void 0 ? false : _e, _f = _b.preloadBlurryRecognition, preloadBlurryRecognition = _f === void 0 ? true : _f, _g = _b.preloadEngine, preloadEngine = _g === void 0 ? true : _g;
