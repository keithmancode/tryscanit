...
function dataCapture() {
    ...
    function loadLibrary(deviceId, libraryLocation, locationPath, preload, newDelayedRegistration, newHighEndBlurryRecognition, textRecognition, newLicenseKey, deviceModelName) {
        ...
        var _a = getLibraryLocationURIs(libraryLocation, textRecognition), jsURI = _a.jsURI, wasmURI = _a.wasmURI;
        preloading = preload;
            ...
            instantiateWasm: function (importObject, successCallback) {
                ...
                if (wasmJSVersion !== "5.8.0") {
                    console.error("The Scandit Data Capture library JS file found at " + jsURI + " seems invalid: " +
                        ("expected version doesn't match (received: " + wasmJSVersion + ", expected: " + "5.8.0" + "). ") +
    ...
    function getLibraryLocationURIs(libraryLocation, textRecognition) {
        ...
        if (cdnURI) {
            return {
                jsURI: libraryLocation + "scandit-engine-sdk" + (textRecognition ? "-ocr" : "") + ".min.js",
                wasmURI: libraryLocation + "scandit-engine-sdk" + (textRecognition ? "-ocr" : "") + ".wasm",
            };
        }
        return {
            jsURI: libraryLocation + "scandit-engine-sdk" + (textRecognition ? "-ocr" : "") + ".min.js?v=5.8.0",
            wasmURI: libraryLocation + "scandit-engine-sdk" + (textRecognition ? "-ocr" : "") + ".wasm?v=5.8.0",
        };
    }
        ...
        function verifyResponseData(responseData) {
            ...
            if (typeof ((_a = crypto === null || crypto === void 0 ? void 0 : crypto.subtle) === null || _a === void 0 ? void 0 : _a.digest) === "function") {
                crypto.subtle
                    ...
                    var expectedHashString = textRecognition ? "%SDC_OCR_WASM_HASH%" : "af589054f25bfd099045069f48e42986dabd545d2207d5046fea447d49bfd11a";
                    // istanbul ignore if
    ...
    function instantiateWebAssembly(importObject, wasmURI, textRecognition, successCallback) {
        verifiedWasmFetch(wasmURI, textRecognition, true)
            .then(function (response) {
    ...
    function instantiateWebAssemblyStreaming(importObject, wasmURI, textRecognition, successCallback) {
        verifiedWasmFetch(wasmURI, textRecognition, false)
            .then(function (response) {
