...
AppComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: AppComponent, selectors: [["app-root"]], viewQuery: function AppComponent_Query(rf, ctx) { if (rf & 1) {
    ...
    } }, decls: 11, vars: 4, consts: [[1, "container"], [1, "logo"], [1, "name"], ["id", "description", "class", "description", 4, "ngIf"], ["id", "lib-loading", 4, "ngIf"], ["id", "barcode-picker-starter-button", 3, "click", 4, "ngIf"], ["id", "barcode-result", 1, "result-text"], ["id", "barcode-picker", "configure.licenseKey", "", "configure.engineLocation", "https://cdn.jsdelivr.net/npm/scandit-sdk@5.x/build/", "scanningPaused", "true", "visible", "false", "playSoundOnScan", "true", "vibrateOnScan", "true", "scanSettings.enabledSymbologies", "[\"ean8\", \"ean13\", \"upca\", \"upce\"]", 3, "ready", "scan"], ["barcodePicker", ""], ["id", "description", 1, "description"], ["id", "lib-loading"], ["id", "barcode-picker-starter-button", 3, "click"]], template: function AppComponent_Template(rf, ctx) { if (rf & 1) {
